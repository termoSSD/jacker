import os, sys, time
from core.utils.config import get_auto_load_status, get_setting
from core.utils.cmd_ui import clear, exit_program, print_error, print_info, show_menu, print_smoothly, check_for_updates
from core.ai.engine import get_or_set_model
import core.ai.engine as ai
